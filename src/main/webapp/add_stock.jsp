        ...
        <div class="min-h-screen bg-gray-100 flex flex-col pt-4">
            <div class="p-10 xs:p-0 mx-auto md:w-full md:max-w-md">
                <div class="text-center mb-6">
                    <p class="mt-2 text-3xl font-extrabold text-gray-900 sm:text-4xl">Create New Stock</p>
                </div>
                <form action="add_stock" method="POST">
                    <div class="bg-white shadow w-full rounded-lg divide-y divide-gray-200">
                        <div class="px-5 pt-7 pb-5">
                            ...
                            <input type="date" name="purchase_date" id="purchase_date" class="border rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full" />

                            <label class="font-semibold text-sm text-gray-600 pb-1 block">Expire Date</label>
                            <input type="date" name="expire_date" id="expire_date" class="border rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full" />
