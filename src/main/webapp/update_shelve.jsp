        ...
        <div class="min-h-screen bg-gray-100 flex flex-col pt-4">
            <div class="p-10 xs:p-0 mx-auto md:w-full md:max-w-md">
                <div class="text-center mb-6">
                    <p class="mt-2 text-3xl font-extrabold text-gray-900 sm:text-4xl">Update Shelve Details</p>
                </div>
                <form action="update_shelve" method="POST">
                    <div class="bg-white shadow w-full rounded-lg divide-y divide-gray-200">
                        <div class="px-5 pt-7 pb-5">
                            <label class="font-semibold text-sm text-gray-600 pb-1 block">Enter Shelve ID</label>
                            <input type="text" name="shelve_id" id="shelve_id" class="border rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full" />
